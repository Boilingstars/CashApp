...
LLM_REQUEST_TIMEOUT = env.float('LLM_REQUEST_TIMEOUT', default=120.0)
LLM_MAX_RETRIES = env.int('LLM_MAX_RETRIES', default=1)
MAX_CHAT_HISTORY_MESSAGES = env.int('MAX_CHAT_HISTORY_MESSAGES', default=20)

# Gunicorn (передаётся через entrypoint.sh)
GUNICORN_WORKERS = env.int('GUNICORN_WORKERS', default=2)
